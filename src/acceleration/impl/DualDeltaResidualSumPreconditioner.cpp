...
DualDeltaResidualSumPreconditioner::DualDeltaResidualSumPreconditioner(
    int maxNonConstTimesteps)
    : Preconditioner(maxNonConstTimesteps)
{
}

void DualDeltaResidualSumPreconditioner::initialize(std::vector<size_t> &svs)
{
  PRECICE_TRACE();
...
void DualDeltaResidualSumPreconditioner::_update_(bool                   timestepComplete,
